...
const torusKnotOne = new THREE.Mesh(torusKnotGeometry, torusKnotMaterial)
torusKnotOne.position.set(6, 1, 1)
torusKnotOne.castShadow = true
scene.add(torusKnotOne)
torusKnotOne.scale.x = 0.5
torusKnotOne.scale.y = 0.5
torusKnotOne.scale.z = 0.5
...
const animation = () => 
{
    ...
    torusKnotOne.rotation.y = elapsedTime
