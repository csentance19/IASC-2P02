...
const animation = () => 
{
    ...
    {
        statue.position.z = Math.sin(elapsedTime) * 2
        statue.position.y = Math.cos(elapsedTime) + 3
        
    }
    // second-change
    if(domObject.secondChange) 
    {
        statue.rotation.z = Math.sin(elapsedTime)
    ...
    {
        statue.position.x = Math.sin(elapsedTime) + 19.5
    }
